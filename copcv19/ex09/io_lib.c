...
/* reads fundamental matrix from file */

{
                        /*****************************************************/
    FILE        *file;  /* file pointer                                      */
    long double help;   /* tmp variable                                      */
    int         i,j;    /* loop variable                                     */
                        /*****************************************************/

    printf("\n Trying to read fundamental matrix file %s ...",filename);
...
void write_fundamental_matrix
(
                      /*******************************************************/
    char  *filename,  /* in : file name                                      */
    double **F        /* in : fundamental matrix                             */
                      /*******************************************************/
)

/* write fundamental matrix to file */

{
    ...
    printf("\n Trying to write fundamentalm matrix file %s ...",filename);
