...
int ALLOC_VECTOR_DOUBLE
                             
(                   /********************************************************/
 int   n,           /* number of vectors                                    */
 int   nx,          /* size in x direction                                  */
 double **args,      /* pointer for each vector -> n arguments               */
 ...                /*                                                      */
)                   /********************************************************/

{                      /*****************************************************/
  double ***ptr_array;  /* auxiliary pointer for arguments                   */
  double **call_ptr;    /* auxiliary pointer for function call               */
  int   i;             /* counter variable                                  */
  va_list ap;          /* object for traversing the arguments               */
                       /*****************************************************/
  ...
  /* call core routine with call_ptr                                        */
  /**************************************************************************/
  alloc_mem_linear((void**)(&call_ptr),sizeof(double), 2, n, nx);
...
int ALLOC_MATRIX_DOUBLE
                             
(                   /********************************************************/
 int   n,           /* number of matrices                                   */
 int   nx,          /* size in x direction                                  */
 int   ny,          /* size in y direction                                  */
 double ***args,     /* pointer for each matrix -> n arguments               */
 ...                /*                                                      */
)                   /********************************************************/
...
{                      /*****************************************************/
  ...
  /* call core routine with call_ptr                                        */
  /**************************************************************************/
  alloc_mem_linear((void**)(&call_ptr),sizeof(double), 3, n, nx, ny);
...
int FREE_VECTOR_DOUBLE
                             
(                   /********************************************************/
 int   n,           /* number of vectors                                    */
 int   nx,          /* size in x direction                                  */ 
 double *args,       /* vectors -> n arguments                               */
 ...                /*                                                      */
)                   /********************************************************/
...
{                      /*****************************************************/
  ...
  /* free memory of main vector                                             */
  /**************************************************************************/
  free_mem_linear((void*)(ptr_array[0]),sizeof(double), 1, nx);
...
int FREE_MATRIX_DOUBLE
                             
(                   /********************************************************/
 int   n,           /* number of matrices                                   */
 int   nx,          /* size in x direction                                  */
 int   ny,          /* size in y direction                                  */
 double **args,      /* matrices -> n arguments                              */
 ...                /*                                                      */
)                   /********************************************************/
...
{                      /*****************************************************/
  ...
  /* free memory of main matrix                                             */
  /**************************************************************************/
  free_mem_linear((void*)(ptr_array[0]),sizeof(double), 2, nx, ny);
...
(                   /********************************************************/
 ...
 int   ny,          /* size in y direction                                  */ 
 int   nz,          /* size in z direction                                  */
 double ****args,    /* pointer for each cubix -> n arguments                */
 ...                /*                                                      */
)                   /********************************************************/
...
{                      /*****************************************************/
  ...
  /* call core routine with call_ptr                                        */
  /**************************************************************************/
  alloc_mem_linear((void**)(&call_ptr),sizeof(double), 4, n, nx, ny, nz);
...
(                   /********************************************************/
 ...
 int   ny,          /* size in y direction                                  */
 int   nz,          /* size in z direction                                  */
 double ***args,     /* cubices -> n arguments                               */
 ...                /*                                                      */
)                   /********************************************************/
...
{                      /*****************************************************/
  ...
  /* free memory of main cubix                                              */
  /**************************************************************************/
  free_mem_linear((void*)(ptr_array[0]),sizeof(double), 3, nx, ny, nz);
